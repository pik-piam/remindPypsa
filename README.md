...
R package **remindPypsa**, version **0.0.1.9003**
...
Odenweller A (2022). _remindPypsa: REMIND-PyPSA model coupling scripts_. R package version 0.0.1.9003, <https://github.com/pik-piam/remindPypsa>.
