...
R package **remindPypsa**, version **0.0.1.9026**
...
Odenweller A (2023). _remindPypsa: REMIND-PyPSA model coupling scripts_. R package version 0.0.1.9026, <https://github.com/pik-piam/remindPypsa>.
...
@Manual{,
  ...
  year = {2023},
  note = {R package version 0.0.1.9026},
